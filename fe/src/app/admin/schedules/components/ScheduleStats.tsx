...
export function ScheduleStats() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
      <StatCard icon={CalendarIcon} color="bg-blue-100 text-blue-600" label="Tổng Suất Chiếu" value="248" />
      <StatCard icon={Clock} color="bg-green-100 text-green-600" label="Hôm Nay" value="32" />
      <StatCard icon={Film} color="bg-orange-100 text-orange-600" label="Phim Đang Chiếu" value="15" />
      <StatCard icon={MapPin} color="bg-purple-100 text-purple-600" label="Rạp Hoạt Động" value="8" />
    </div>
  );
}
