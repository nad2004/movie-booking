...
import ShiftTemplatesTab from './components/shift-templates-tab';
import WorkPlanningTab from './components/work-planning-tab';
import ShiftAssignmentsTab from './components/shift-assignments-tab';
