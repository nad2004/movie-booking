...
export function TheaterTable({ theaters, isLoading, onEdit, onDelete }: TheaterTableProps) {
  ...
  if (theaters.length === 0) return <div className="text-center py-10 text-gray-500">Không có dữ liệu.</div>;
          ...
          {theaters.map((theater) => (
            <TableRow key={theater._id} className="hover:bg-gray-50/50">
              ...
              <TableCell className="text-center">
                <Badge className={theater.isActive ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}>
