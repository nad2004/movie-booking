      ...
      <DialogContent className="sm:max-w-[400px]">
        ...
        <div className="py-4 space-y-4">
            <div className="p-3 bg-gray-50 rounded-lg text-sm">
                <p><span className="font-semibold">Mã vé:</span> {ticket?.bookingCode}</p>
                <p><span className="font-semibold">Phim:</span> {ticket?.movieTitle}</p>
                <p><span className="font-semibold">Khách:</span> {ticket?.customer?.fullName}</p>
            </div>
            ...
            <div className="space-y-2">
                ...
                <Select 
                    value={status} 
                    onValueChange={(val) => setValue("status", val as BookingStatus)}
                >
                    <SelectTrigger>
        ...
        <DialogFooter>
            ...
            <Button onClick={handleSubmit(onSubmit)} disabled={isLoading} className="bg-primary text-white">
