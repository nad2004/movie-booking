              ...
              {selectedSeats.length > 0 ? (
                  <div className="flex flex-wrap gap-1.5">
                      {selectedSeats.map(seat => (
                          <Badge key={seat.seatNumber} className="bg-blue-100 text-blue-700 hover:bg-blue-200 border-0 text-xs px-1.5">
                              {seat.seatNumber}
                          </Badge>
                      ))}
                  </div>
          ...
          <div className="space-y-2 mb-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                  ...
                  <button
                      ...
                      className={`p-2 rounded-lg border text-xs font-medium flex flex-col items-center gap-1 transition-all ${
                          paymentMethod === 'VNPAY' ? 'border-primary bg-primary/5 text-primary' : 'border-gray-200 hover:bg-gray-50'
                      }`}
                  >
